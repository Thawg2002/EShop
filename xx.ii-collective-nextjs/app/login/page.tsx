    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <div className="w-full lg:w-1/2 flex flex-col h-full bg-white relative overflow-y-auto">
                ...
                {/* Form Container */}
                <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-20 xl:px-32 py-12">
                    {/* Logo & Title */}
                    <BlurFade delay={0.2}>
                        <div className="text-center mb-12">
                            <div className="inline-flex items-center justify-center gap-3 mb-6">
                                <span className="material-symbols-outlined text-primary text-[28px]">diamond</span>
                                <AnimatedGradientText className="text-4xl font-serif-display font-bold tracking-[0.25em]">
                                    XX.II
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <BlurFade delay={0.7}>
                            <div className="pt-4">
                                <ShimmerButton
                                    type="submit"
                                    className="w-full h-14 text-white rounded-sm"
                                    shimmerColor="#ffffff"
                        ...
                        <BlurFade delay={0.9}>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    <button
                                        type="button"
                                        className="flex items-center justify-center gap-3 w-full bg-white py-3 text-gray-600 hover:text-gray-900 transition-all duration-300 group"
                                    >
                                        <svg
