    ...
    return (
        <PageLayout>
            <Section className="py-20">
                <BlurFade delay={0.1}>
                    <h1 className="text-4xl md:text-5xl font-serif-display italic text-dark-text dark:text-dark-text-primary mb-8">
                        Chính Sách Quyền Riêng Tư
                    </h1>
                </BlurFade>

                <div className="prose prose-lg dark:prose-invert max-w-none text-muted-text dark:text-dark-text-secondary space-y-6">
                    <BlurFade delay={0.2}>
                        <p>
                    ...
                    <BlurFade delay={0.3}>
                        <h2 className="text-2xl font-serif-display text-dark-text dark:text-dark-text-primary mt-8 mb-4">
