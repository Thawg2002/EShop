...
import { CreditCard, Truck, MapPin, CheckCircle, ChevronLeft, ShieldCheck, ShoppingBag } from 'lucide-react';
    ...
    if (items.length === 0) {
        return (
            <div className="min-h-screen pt-40 flex flex-col items-center justify-center">
                ...
                <Link href="/cua-hang" className="bg-primary text-white px-8 py-3 rounded-full uppercase text-xs font-bold">Quay lại cửa hàng</Link>
            </div>
        );
    }
        ...
        <div className="min-h-screen pt-32 pb-20 bg-background text-foreground">
            <div className="container mx-auto px-6">
                <div className="max-w-6xl mx-auto">
                    ...
                    <h1 className="text-5xl font-bold mb-12">Thanh toán</h1>
                            ...
                            <section className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] uppercase font-bold text-muted-foreground">Họ và tên</label>
                                        <input
                                            name="fullName"
                                    ...
                                    <div className="md:col-span-2 space-y-2">
                                        <label className="text-[10px] uppercase font-bold text-muted-foreground">Địa chỉ (Số nhà, Tên đường)</label>
                                        <input
                                            name="street"
                                    ...
                                    <div className="md:col-span-2 space-y-2">
                                        <label className="text-[10px] uppercase font-bold text-muted-foreground">Quận/Huyện, Tỉnh/Thành phố</label>
                                        <input
                                            name="province"
                                    ...
                                    >
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-[10px] text-muted-foreground uppercase">Trả tiền mặt khi giao hàng</p>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-[10px] text-muted-foreground uppercase">Xử lý bảo mật qua Stripe</p>
                                            </div>
                                        </div>
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-muted/30 rounded-3xl p-8 sticky top-32 space-y-8 border border-border/50 shadow-sm">
                                        ...
                                        <div key={item._id} className="flex justify-between items-start">
                                            <div className="flex space-x-4">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">Số lượng: {item.quantity}</p>
                                                    {item.variant && <p className="text-[10px] text-muted-foreground uppercase">{item.variant.size} / {item.variant.color}</p>}
                                                </div>
                                            </div>
                                ...
                                <div className="border-t border-border pt-6 space-y-4">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        <span className="text-muted-foreground">Phí giao hàng (GHTK)</span>
                                ...
                                <button
                                    ...
                                    className="w-full bg-primary text-white py-5 rounded-full font-bold uppercase tracking-widest text-xs flex items-center justify-center space-x-3 shadow-lg transition-all hover:-translate-y-1 active:scale-95 disabled:opacity-50"
                                >
